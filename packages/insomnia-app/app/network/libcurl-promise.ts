...
export const libCurlPromise = (options: Record<any, any>, bodyPath, maxTimelineDataSizeKB) => new Promise<{patch:ResponsePatch; debugTimeline: any; headerArray: any[]}>(async resolve => {
  // Create instance, poke value options in, set up write and debug callbacks
  const curl = new Curl();
